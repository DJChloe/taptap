    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (destdirectory='') then destdirectory:=TDirectory.GetCurrentDirectory;
          ...
          begin
            if (not TDirectory.Exists(destdirectory))
            then TDirectory.CreateDirectory(destdirectory);
          end;
        end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          if (not TDirectory.Exists(Adir))
          then TDirectory.CreateDirectory(Adir);
          result:=true;
        end;
  ...
  begin
    ...
    begin
      ...
      begin
       ...
       if GetFileSize(tapname)=0 then TFile.Delete(tapname);
      end;
    end
