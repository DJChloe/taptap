...
implementation
uses classes,sysutils,generics.collections,unitutils;

procedure cat_command(TapName:string);
var Catalogue:TList<Toricfile>;
    OricFile:TOricFile;
    size:integer;
...
begin
  ...
  try
    ...
    for index:=0 to Catalogue.Count-1 do
    begin
      OricFile:=Catalogue.Items[index];
      writeln('Index.... : ',index);
        ...
        case OricFile.ofk of
          ...
          begin
            ...
            begin
              ...
              if (index<(Catalogue.Count-1)) then
